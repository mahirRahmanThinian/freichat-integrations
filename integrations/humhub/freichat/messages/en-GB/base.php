<?php
    return [
        ...
        'Who should be visible in user list:' => 'Who should be visible in user list:',
        'The users will be filtered based on the option selected' => 'The users will be filtered based on the option selected',
        'Save' => 'Save',
